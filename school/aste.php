...
$r=mysqli_query($conn,"SELECT * FROM `ass` WHERE chass='$cl'" ); 
$r2=mysqli_query($conn,"SELECT * FROM `ass` WHERE id= '$ed'"); 
...
<meta  name="viewport" content="width=device-width,intial-scale=1.0"/> 
    ...
    <body>
      ...
      <div ><center><a href="as.php"><button style="width:30%;height:40px;color:#ffff00;background-color:#0f0f00;font-size:15px;"> الصفحة الرئيسية</button></a>
     <h1>الاسلامية  </h1>
...
$sql = "UPDATE ass SET k='$lk'  WHERE id='$row[0]' ";
if ($conn->query($sql) === TRUE) {
echo "Record updated successfully";
header("Location:as.php?edit=33");
} else {
...
$sql = "UPDATE ass SET l='$ex'  WHERE id='$row[0]' ";
if ($conn->query($sql) === TRUE) {
echo "Record updated successfully";
header("Location:as.php?edit=33");
} else {
echo "Error updating record: " . $conn->error;
   ...
   <?php
            ...
            <tr>
                ...
                <th>id</th> <th>الاسم</th> <th>اليومي</th> <th>الشهر الاول</th><th>اليومي</th> <th>الشهر الثاني</th> <th>سعي</th><th>تحضير</th><th>امتحان</th><th>عدد ايام الغياب</th> <th>الملاحضات</th>  <th>aciton</th>
</tr> 
<form action="" method="post" enctype="multipart/form-data">
       <td> <input type="text" name="name" id="te" value="<?php echo $_GET['edit']; ?>"></td>
       <td> <input type="text" name="a" style="width:170px; font-size:20px;"id="te"value="<?php echo $row[1]; ?>"></td>
             ...
             <td style="width:3%; font-size:20px;"><?php echo $row[0];?></td> 
              ...
              <td><?php echo $row[10];?></td> 
               <td><?php echo $row[11];?></td> 
                ...
                <td style="background-color:#00ff00;color:#ffffff;"><a href="aste.php?edit=<?php echo $row['id'];?>">اختيار</a></td>
             <?php echo "</tr>";}?>
<?php
if(isset($_GET['edit'])){
}
...
$sql = "UPDATE ass SET a='$aa',c='$cc' , d='$dd' ,  i='$ff',g='$gg' , k='$hh',l='$ii' , m='$jj',n='$kk'  WHERE id=$id ";
if ($conn->query($sql) === TRUE) {
echo "Record updated successfully";
} else {
echo "Error updating record: " . $conn->error;
