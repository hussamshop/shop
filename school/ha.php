...
if (isset($_POST["submit"])){
     $_SESSION['class']="a1";
            header("Location:hate.php?edit=1101");
...
if (isset($_POST["submit1"])){
     $_SESSION['class']="a2";
            header("Location:hate.php?edit=1201");
...
if (isset($_POST["submit2"])){
     $_SESSION['class']="a3";
            header("Location:hate.php?edit=1301");
...
if (isset($_POST["submit3"])){
     $_SESSION['class']="a4";
            header("Location:hate.php?edit=1401");
                                ...
                                if (isset($_POST["submi2t4"])){
                                     $_SESSION['class']="a5";
                                        ...
                                        if (isset($_POST["submi3t"])){
                                             $_SESSION['class']="b1";
                                                    header("Location:hate.php?edit=2101");
                                        ...
                                        if (isset($_POST["submi3t1"])){
                                             $_SESSION['class']="b2";
                                             header("Location:hate.php?edit=2201");
                                                }
                                        ...
                                        if (isset($_POST["submi3t2"])){
                                             $_SESSION['class']="b3";
                                             header("Location:hate.php?edit=2301");
                                                }
                                        ...
                                        if (isset($_POST["submi3t3"])){
                                             $_SESSION['class']="b4";
                                             header("Location:hate.php?edit=2401");
                                                }
                                                if($row[6]=="b1"){
                                                    echo '<form action=""method="post">
                                                    <input type="text"name="class" style="width:0px;height: 0px;">
