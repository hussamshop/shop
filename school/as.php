...
if (isset($_POST["submit"])){
     $_SESSION['class']="a1";
            header("Location:aste.php?edit=1101");
...
if (isset($_POST["submit1"])){
     $_SESSION['class']="a2";
            header("Location:aste.php?edit=1201");
...
if (isset($_POST["submit2"])){
     $_SESSION['class']="a3";
            header("Location:aste.php?edit=1301");
...
if (isset($_POST["submit3"])){
     $_SESSION['class']="a4";
            header("Location:aste.php?edit=1401");
...
if (isset($_POST["submit4"])){
     $_SESSION['class']="a5";
            header("Location:aste.php?edit=1501");
                ...
                if (isset($_POST["submi2t4"])){
                     $_SESSION['class']="a5";
                        ...
                        if($row[8]=="a1"){
                            echo '<form action=""method="post">
                            <input type="text"name="class" style="width:0px;height: 0px;">
                            <input type="submit"name="submi3t" value="الصف الاول أ" style="width:300px;height: 70px;font-size:40px ;background-color:#55f377;">
                        </form>';
                        ...
                        if (isset($_POST["submi3t"])){
                             $_SESSION['class']="a1";
                                ...
                                if($row[8]=="a2"){
                                    echo '<form action=""method="post">
                                    <input type="text"name="class"style="width:0px;height: 0px;"  >
                                    <input type="submit"name="submi3t1" value="الصف الاول ب" style="width:300px;height: 70px;font-size:40px ;background-color:#55f377;">
                        ...
                        if (isset($_POST["submi3t1"])){
                             $_SESSION['class']="a2";
                                ...
                                if($row[8]=="a3"){
                                    echo '<form action=""method="post">
                                    <input type="text"name="class"style="width:0px;height: 0px;"  >
                                    <input type="submit"name="submi3t2" value="الصف الاول ج" style="width:300px;height: 70px;font-size:40px ;background-color:#55f377;">
                        ...
                        if (isset($_POST["submi3t2"])){
                             $_SESSION['class']="a3";
                                ...
                                if($row[8]=="a4"){
                                    echo '<form action=""method="post">
                                    <input type="text"name="class"style="width:0px;height: 0px;"  >
                                    <input type="submit"name="submi3t3" value="الصف الاول د" style="width:300px;height: 70px;font-size:40px ;background-color:#55f377;">
                        ...
                        if (isset($_POST["submi3t3"])){
                             $_SESSION['class']="a4";
                                ...
                                if($row[8]=="a5"){
                                    echo '<form action=""method="post">
                                    <input type="text"name="class"style="width:0px;height: 0px;"  >
                                    <input type="submit"name="submi3t4" value="الصف الاول ه" style="width:300px;height: 70px;font-size:40px ;background-color:#55f377;">
                                
                                </form>';
                                
                                }
                        
                        if (isset($_POST["submi3t4"])){
                             $_SESSION['class']="a5";
                                    header("Location:aste.php?edit=1501");
                                ...
                                if($row[9]=="a1"){
                                    echo '<form action=""method="post">
                                    <input type="text"name="class" style="width:0px;height: 0px;">
                                    <input type="submit"name="submi4t" value="الصف الاول أ" style="width:300px;height: 70px;font-size:40px ;background-color:#55f377;">
                                </form>';
                                ...
                                if (isset($_POST["submi4t"])){
                                     $_SESSION['class']="a1";
                                        ...
                                        if($row[9]=="a2"){
                                            echo '<form action=""method="post">
                                            <input type="text"name="class"style="width:0px;height: 0px;"  >
                                            <input type="submit"name="submi4t1" value="الصف الاول ب" style="width:300px;height: 70px;font-size:40px ;background-color:#55f377;">
                                ...
                                if (isset($_POST["submi4t1"])){
                                     $_SESSION['class']="a2";
                                        ...
                                        if($row[9]=="a3"){
                                            echo '<form action=""method="post">
                                            <input type="text"name="class"style="width:0px;height: 0px;"  >
                                            <input type="submit"name="submi4t2" value="الصف الاول ج" style="width:300px;height: 70px;font-size:40px ;background-color:#55f377;">
                                ...
                                if (isset($_POST["submi4t2"])){
                                     $_SESSION['class']="a3";
                                        ...
                                        if($row[9]=="a4"){
                                            echo '<form action=""method="post">
                                            <input type="text"name="class"style="width:0px;height: 0px;"  >
                                            <input type="submit"name="submi4t3" value="الصف الاول د" style="width:300px;height: 70px;font-size:40px ;background-color:#55f377;">
                                ...
                                if (isset($_POST["submi4t3"])){
                                     $_SESSION['class']="a4";
                                        ...
                                        if($row[9]=="a5"){
                                            echo '<form action=""method="post">
                                            <input type="text"name="class"style="width:0px;height: 0px;"  >
                                            <input type="submit"name="submi4t4" value="الصف الاول ه" style="width:300px;height: 70px;font-size:40px ;background-color:#55f377;">
                                        
                                        </form>';
                                        
                                        }
                                
                                if (isset($_POST["submi4t4"])){
                                     $_SESSION['class']="a5";
                                            header("Location:aste.php?edit=1501");
                                        ...
                                        if (isset($_POST["submi5t"])){
                                             $_SESSION['class']="b1";
                                                    header("Location:aste.php?edit=2101");
                                        ...
                                        if (isset($_POST["submi5t1"])){
                                             $_SESSION['class']="b2";
                                             header("Location:aste.php?edit=2201");
                                                }
                                        ...
                                        if (isset($_POST["submi5t2"])){
                                             $_SESSION['class']="b3";
                                             header("Location:aste.php?edit=2301");
                                                }
                                        ...
                                        if (isset($_POST["submi5t3"])){
                                             $_SESSION['class']="b4";
                                             header("Location:aste.php?edit=2401");
                                                }
                                                if($row[6]=="b1"){
                                                    echo '<form action=""method="post">
                                                    <input type="text"name="class" style="width:0px;height: 0px;">
                                                        ...
                                                        if (isset($_POST["submi7t3"])){
                                                             ...
                                                             header("Location:aste.php?edit=2401");
                                                                ...
                                                                if($row[8]=="b1"){
                                                                    echo '<form action=""method="post">
                                                                    <input type="text"name="class" style="width:0px;height: 0px;">
                                                                    <input type="submit"name="submi8t" value="الصف الثاني أ" style="width:300px;height: 70px;font-size:40px ;background-color:#55f377;">
                                                                </form>';
                                                                
                                                                }  
                                                                
                                                                if (isset($_POST["submi8t"])){
                                                                     $_SESSION['class']="b1";
                                                                     header("Location:aste.php?edit=2101");
                                                                        }
                                                                        ...
                                                                        if($row[8]=="b2"){
                                                                            echo '<form action=""method="post">
                                                                            <input type="text"name="class"style="width:0px;height: 0px;"  >
                                                                            <input type="submit"name="submi8t1" value="الصف الثاني ب" style="width:300px;height: 70px;font-size:40px ;background-color:#55f377;">
                                                                        
                                                                        </form>';
                                                                        }
                                                                
                                                                if (isset($_POST["submi8t1"])){
                                                                     $_SESSION['class']="b2";
                                                                     header("Location:aste.php?edit=2201");
                                                                        }
                                                                        ...
                                                                        if($row[8]=="b3"){
                                                                            echo '<form action=""method="post">
                                                                            <input type="text"name="class"style="width:0px;height: 0px;"  >
                                                                            <input type="submit"name="submi8t2" value="الصف الثاني ج" style="width:300px;height: 70px;font-size:40px ;background-color:#55f377;">
                                                                        
                                                                        </form>';
                                                                        
                                                                        }
                                                                if (isset($_POST["submi8t2"])){
                                                                     $_SESSION['class']="b3";
                                                                     header("Location:aste.php?edit=2301");
                                                                        }
                                                                        ...
                                                                        if($row[8]=="b4"){
                                                                            echo '<form action=""method="post">
                                                                            <input type="text"name="class"style="width:0px;height: 0px;"  >
                                                                            <input type="submit"name="submi8t3" value="الصف الثاني د" style="width:300px;height: 70px;font-size:40px ;background-color:#55f377;">
                                                                        
                                                                        </form>';
                                                                        
                                                                        }
                                                                
                                                                if (isset($_POST["submi8t3"])){
                                                                     $_SESSION['class']="b4";
                                                                     header("Location:aste.php?edit=2401");
                                                                        }
                                                                        if($row[9]=="b1"){
                                                                            echo '<form action=""method="post">
                                                                            <input type="text"name="class" style="width:0px;height: 0px;">
                                                                            <input type="submit"name="submi9t" value="الصف الثاني أ" style="width:300px;height: 70px;font-size:40px ;background-color:#55f377;">
                                                                        </form>';
                                                                        
                                                                        }  
                                                                        
                                                                        if (isset($_POST["submi9t"])){
                                                                             $_SESSION['class']="b1";
                                                                             header("Location:aste.php?edit=2101");
                                                                                }
                                                                                ...
                                                                                if($row[9]=="b2"){
                                                                                    echo '<form action=""method="post">
                                                                                    <input type="text"name="class"style="width:0px;height: 0px;"  >
                                                                                    <input type="submit"name="submi9t1" value="الصف الثاني ب" style="width:300px;height: 70px;font-size:40px ;background-color:#55f377;">
                                                                                
                                                                                </form>';
                                                                                }
                                                                        
                                                                        if (isset($_POST["submi9t1"])){
                                                                             $_SESSION['class']="b2";
                                                                                    header("Location:aste.php?edit=2201");
                                                                                ...
                                                                                if($row[9]=="b3"){
                                                                                    echo '<form action=""method="post">
                                                                                    <input type="text"name="class"style="width:0px;height: 0px;"  >
                                                                                    <input type="submit"name="submi9t2" value="الصف الثاني ج" style="width:300px;height:70px;font-size:40px ;background-color:#55f377;">
                                                                                
                                                                                </form>';
                                                                                
                                                                                }
                                                                        if (isset($_POST["submi9t2"])){
                                                                             $_SESSION['class']="b3";
                                                                             header("Location:aste.php?edit=2301");
                                                                                }
                                                                                ...
                                                                                if($row[9]=="b4"){
                                                                                    echo '<form action=""method="post">
                                                                                    <input type="text"name="class"style="width:0px;height: 0px;"  >
                                                                                    <input type="submit"name="submi9t3" value="الصف الثاني د" style="width:300px;height: 70px;font-size:40px ;background-color:#55f377;">
                                                                                
                                                                                </form>';
                                                                                
                                                                                }
                                                                        
                                                                        if (isset($_POST["submi9t3"])){
                                                                             $_SESSION['class']="b4";
                                                                             header("Location:aste.php?edit=2401");
  ...
  <input type="text"name="class"style="width:0px;height: 0px;"  >
  <input type="submit"name="submi9t5" value="  تسجيل الخروج" style="width:300px;height: 70px;font-size:40px ;background-color:#ff0000;">

</form><?php
if (isset($_POST["submi9t5"])){
    session_unset();
    session_destroy();
