...
<html>
    ...
    <body style="background-color:#00a0a0;">
        <div >
<center><h1>الاجتماعيات</h1></center>
        </div>
        <div><center><?php
        if($row[5]=="a1"){
...
if (isset($_POST["submit0"])){
     $_SESSION['class']="a1";
            header("Location:htete.php?edit=1101");
...
if (isset($_POST["submit10"])){
     $_SESSION['class']="a2";
            header("Location:htete.php?edit=1201");
...
if (isset($_POST["submit20"])){
     $_SESSION['class']="a3";
            header("Location:htete.php?edit=1301");
...
if (isset($_POST["submit30"])){
     $_SESSION['class']="a4";
            header("Location:htete.php?edit=1401");
...
if (isset($_POST["submit40"])){
     $_SESSION['class']="a5";
            header("Location:htete.php?edit=1501");
                ...
                if (isset($_POST["submi1t4"])){
                     $_SESSION['class']="a5";
                        ...
                        if (isset($_POST["submit11"])){
                             $_SESSION['class']="a1";
                                ...
                                if($row[8]=="a2"){
                                    echo '<form action=""method="post">
                                    <input type="text"name="class"style="width:0px;height: 0px;"  >
                                    <input type="submit"name="submit21" value="الصف الاول ب" style="width:300px;height: 70px;font-size:40px ;background-color:#55f377;">
                        ...
                        if (isset($_POST["submit22"])){
                             $_SESSION['class']="a3";
                                ...
                                if($row[8]=="a4"){
                                    echo '<form action=""method="post">
                                    <input type="text"name="class"style="width:0px;height: 0px;"  >
                                    <input type="submit"name="submit23" value="الصف الاول د" style="width:300px;height: 70px;font-size:40px ;background-color:#55f377;">
                        ...
                        if (isset($_POST["submit23"])){
                             $_SESSION['class']="a4";
                                ...
                                if($row[8]=="a5"){
                                    echo '<form action=""method="post">
                                    <input type="text"name="class"style="width:0px;height: 0px;"  >
                                    <input type="submit"name="submit24" value="الصف الاول ه" style="width:300px;height: 70px;font-size:40px ;background-color:#55f377;">
                        ...
                        if (isset($_POST["submit24"])){
                             $_SESSION['class']="a5";
                                    header("Location:hate.php?edit=1501");
                                ...
                                if (isset($_POST["submi2t4"])){
                                     $_SESSION['class']="a5";
                                        ...
                                        if($row[5]=="b1"){
                                            echo '<form action=""method="post">
                                            <input type="text"name="class" style="width:0px;height: 0px;">
                                            <input type="submit"name="submi3t3" value="الصف الثاني أ" style="width:300px;height: 70px;font-size:40px ;background-color:#55f377;">
                                        </form>';
                                        ...
                                        if (isset($_POST["submi3t3"])){
                                             $_SESSION['class']="b1";
                                                    header("Location:htete.php?edit=2101");
                                        ...
                                        if (isset($_POST["submi3t1"])){
                                             $_SESSION['class']="b2";
                                             header("Location:htete.php?edit=2201");
                                                }
                                        ...
                                        if (isset($_POST["submi3t2"])){
                                             $_SESSION['class']="b3";
                                             header("Location:htete.php?edit=2301");
                                                }
                                        ...
                                        if (isset($_POST["submi3t3"])){
                                             $_SESSION['class']="b4";
                                             header("Location:htete.php?edit=2401");
                                                }
                                                if($row[6]=="b1"){
                                                    echo '<form action=""method="post">
                                                    <input type="text"name="class" style="width:0px;height: 0px;">
                                                    <input type="submit"name="submi4t4" value="الصف الثاني أ" style="width:300px;height: 70px;font-size:40px ;background-color:#55f377;">
                                                </form>';
                                                ...
                                                if (isset($_POST["submi4t3"])){
                                                     ...
                                                     header("Location:htete.php?edit=2401");
                                                        ...
                                                        if($row[7]=="b1"){
                                                            echo '<form action=""method="post">
                                                            <input type="text"name="class" style="width:0px;height: 0px;">
                                                            <input type="submit"name="submit44" value="الصف الثاني أ" style="width:300px;height: 70px;font-size:40px ;background-color:#55f377;">
                                                        </form>';
                                                                ...
                                                                if (isset($_POST["submi5t"])){
                                                                     ...
                                                                     header("Location:htete.php?edit=2101");
                                                                        ...
                                                                        if($row[8]=="b2"){
                                                                            echo '<form action=""method="post">
                                                                            <input type="text"name="class"style="width:0px;height: 0px;"  >
                                                                            <input type="submit"name="subm5it1" value="الصف الثاني ب" style="width:300px;height: 70px;font-size:40px ;background-color:#55f377;">
                                                                        
                                                                        </form>';
                                                                        }
                                                                
                                                                if (isset($_POST["subm5it1"])){
                                                                     $_SESSION['class']="b2";
                                                                     header("Location:htete.php?edit=2201");
                                                                        }
                                                                        ...
                                                                        if($row[8]=="b3"){
                                                                            echo '<form action=""method="post">
                                                                            <input type="text"name="class"style="width:0px;height: 0px;"  >
                                                                            <input type="submit"name="subm5it2" value="الصف الثاني ج" style="width:300px;height: 70px;font-size:40px ;background-color:#55f377;">
                                                                        
                                                                        </form>';
                                                                        
                                                                        }
                                                                if (isset($_POST["subm5it2"])){
                                                                     $_SESSION['class']="b3";
                                                                     header("Location:htete.php?edit=2301");
                                                                        }
                                                                        ...
                                                                        if($row[8]=="b4"){
                                                                            echo '<form action=""method="post">
                                                                            <input type="text"name="class"style="width:0px;height: 0px;"  >
                                                                            <input type="submit"name="subm5it3" value="الصف الثاني د" style="width:300px;height: 70px;font-size:40px ;background-color:#55f377;">
                                                                        
                                                                        </form>';
                                                                        
                                                                        }
                                                                
                                                                if (isset($_POST["subm5it3"])){
                                                                     $_SESSION['class']="b4";
                                                                     header("Location:htete.php?edit=2401");
                                                                        }
                                                                        if($row[9]=="b1"){
  ...
  <input type="text"name="class"style="width:0px;height: 0px;"  >
  <input type="submit"name="submi6t5" value="  تسجيل الخروج" style="width:300px;height:70px;font-size:40px ;background-color:#ff0000;">

</form><?php
if (isset($_POST["submi6t5"])){
    session_unset();
    session_destroy();
